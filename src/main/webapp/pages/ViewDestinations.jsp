...
<body>
<h2>All Registered Destinations</h2>
    ...
    <table class="fl-table">
        ...
        <tbody>
            ...
            <tr>
    			...
    			<td>${d.destination_location}</td>
    			<td>${d.destination_cost}</td>
    			<td>${d.destination_duration}</td>
                <td>
                <a href="EditDestination/${d.destination_id}">Edit</a> |
                <a href="DeleteDestination/${d.destination_id}">Delete</a>
                </td>
            </tr>
        </c:forEach>
        <tbody>
