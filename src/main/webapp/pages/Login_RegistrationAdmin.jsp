...
<head>
    ...
    <title>Admin Login & Registration Form</title>
</head>
<body>
   <div class="container">
    <div class="forms">
        <div class="form login">
            ...
            <form action="checkAdminData" method="post">
                ...
                <i class='bx bxs-hide showHidePw'></i>
                </div>
            ...
            <div class="login-signup">
                <span class="text">New Admin?
                    <a href="#" class="text signup-link">Sign-up Now</a>
                </span>
                <br>
                <span class="text">Are You User?
                    <a href="Login_RegistrationUser" class="text signup-link">Go to User Page</a>
                </span>
            </div>
        </div>
        ...
        <div class="form signup">
            ...
            <div class="login-signup">
                <span class="text">Already Created?
